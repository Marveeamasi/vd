...
const SideBarBottomBar = ({section}) => {
  return (
    <aside className='max-xl:fixed max-xl:border-r-0 bg-[#261148] max-xl:border-t-4 max-xl:border-t-[#1409261a] max-xl:justify-between max-xl:rounded-t-xl max-xl:top-auto max-xl:z-50 max-xl:flex-row max-xl:bottom-[0px] max-xl:w-screen max-xl:h-[100px] max-xl:left-0 max-xl:bg-[#261148] h-screen border-r-4 border-r-[#1409261a] sticky left-0 top-0 z-30 w-[380px] flex flex-col font-[500] text-[16px]'>
        ...
        <Link href={'/how-it-works'} className='flex items-center max-xl:flex-row-reverse gap-5 px-10 cursor-pointer'>
        ...
        <Link href={'/upload-footage'} className="flex items-center gap-5 px-10 cursor-pointer max-xl:flex-row-reverse">
